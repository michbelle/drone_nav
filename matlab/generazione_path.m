...
%plot3(ori(1,:),ori(2,:),ori(3,:))

%%salvataggio delle variabili del path migliore

%save('path.mat','ori','Q')


%% ottenuto la matrice dei punti possiamo creare i way-point necessari alla navigazion

%start_longitude=8.544102644505163;
%start_latitude=47.39884301876236;
